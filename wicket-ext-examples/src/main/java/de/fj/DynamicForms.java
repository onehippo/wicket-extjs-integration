...
import de.fj.wickx.AbstractExtButton;
import de.fj.wickx.ExtBoxComponent;
import de.fj.wickx.ExtButton;
import de.fj.wickx.ExtPanel;
import de.fj.wickx.ExtSubmitButton;
import de.fj.wickx.ExtTabPanel;
import de.fj.wickx.form.ExtFieldSet;
import de.fj.wickx.form.ExtFormPanel;
import de.fj.wickx.form.ExtHtmlEditor;
import de.fj.wickx.form.ExtTextField;
import de.fj.wickx.form.ExtTimeField;
import de.fj.wickx.form.VTypes;
import de.fj.wickx.form.ExtFormPanel.LabelAlign;
import de.fj.wickx.layout.ColumnLayout;
import de.fj.wickx.layout.FitLayout;
import de.fj.wickx.layout.FormLayout;
...
public class DynamicForms extends ExamplesPage {
	...
	private void addSimpleForm() {
		...
		ExtTextField<?> field1 = new ExtTextField<String>("1", new Model<String>());
		field1.setWidth(230);
		field1.setFieldLabel(new Model<String>("First Name"));
		field1.setAllowBlank(false);

		ExtBoxComponent field2 = new ExtTextField<String>("2", new Model<String>());
		field2.setWidth(230);
		field2.setFieldLabel(new Model<String>("Last Name"));

		ExtBoxComponent field3 = new ExtTextField<String>("3", new Model<String>());
		field3.setWidth(230);
		field3.setFieldLabel(new Model<String>("Company"));

		ExtTextField<?> field4 = new ExtTextField<String>("4", new Model<String>());
		field4.setWidth(230);
		field4.setFieldLabel(new Model<String>("Email"));
		field4.setVtype(VTypes.EMAIL);

		ExtTimeField<?> field5 = new ExtTimeField<String>("5", new Model<String>());
		field5.setWidth(230);
		field5.setFieldLabel(new Model<String>("Time"));
		field5.setMinValue("8:00am");
		field5.setMaxValue("6:00pm");

		simpleForm.addItem(field1, field2, field3, field4, field4, field5);

		AbstractExtButton saveButton = new ExtSubmitButton("1", new Model<String>("Save"));
		simpleForm.addButton(saveButton);

		AbstractExtButton cancelButton = new ExtButton("2", new Model<String>("Cancel"));
	...
	private void addFieldSetForm() {
		...
		ExtFieldSet fieldset1 = new ExtFieldSet("1");
		...
		ExtTextField<?> field11 = new ExtTextField<String>("1", new Model<String>());
		field11.setWidth(210);
		field11.setFieldLabel(new Model<String>("First Name"));
		field11.setAllowBlank(false);

		ExtBoxComponent field12 = new ExtTextField<String>("2", new Model<String>());
		field12.setWidth(210);
		field12.setFieldLabel(new Model<String>("Last Name"));

		ExtBoxComponent field13 = new ExtTextField<String>("3", new Model<String>());
		field13.setWidth(210);
		field13.setFieldLabel(new Model<String>("Company"));

		ExtTextField<?> field14 = new ExtTextField<String>("4", new Model<String>());
		...
		ExtFieldSet fieldset2 = new ExtFieldSet("2");
		fieldset2.setTitle(new Model<String>("Phone Number"));
		fieldset2.setCollapsible(true);
		fieldset2.setAutoHeight(true);

		ExtBoxComponent field21 = new ExtTextField<String>("1", new Model<String>("(888) 555-1212"));
		field21.setWidth(210);
		field21.setFieldLabel(new Model<String>("Home"));

		ExtBoxComponent field22 = new ExtTextField<String>("2", new Model<String>());
		field22.setWidth(210);
		field22.setFieldLabel(new Model<String>("Business"));

		ExtBoxComponent field23 = new ExtTextField<String>("3", new Model<String>());
		field23.setWidth(210);
		field23.setFieldLabel(new Model<String>("Mobile"));

		ExtBoxComponent field24 = new ExtTextField<String>("4", new Model<String>());
	...
	private void addMultiColumnForm() {
		...
		ExtPanel columnLayout = new ExtPanel("1");
		columnLayout.setLayout(new ColumnLayout());

		ExtPanel leftForm = new ExtPanel("1");
		leftForm.setColumnWidth(.5);
		leftForm.setLayout(new FormLayout());

		ExtBoxComponent left1 = new ExtTextField<String>("1", new Model<String>());
		left1.setFieldLabel(new Model<String>("First Name"));
		left1.setAnchor("95%");
		ExtBoxComponent left2 = new ExtTextField<String>("2", new Model<String>());
		left2.setFieldLabel(new Model<String>("Company"));
		left2.setAnchor("95%");

		leftForm.addItem(left1, left2);

		ExtPanel rightForm = new ExtPanel("2");
		rightForm.setColumnWidth(.5);
		rightForm.setLayout(new FormLayout());

		ExtBoxComponent right1 = new ExtTextField<String>("1", new Model<String>());
		right1.setFieldLabel(new Model<String>("Last Name"));
		right1.setAnchor("95%");
		ExtTextField<?> right2 = new ExtTextField<String>("2", new Model<String>());
		...
		ExtHtmlEditor<String> editor = new ExtHtmlEditor<String>("2");
		// editor.setId("bio");
	...
	private void addTabForm() {
		...
		ExtTabPanel tabPanel = new ExtTabPanel("1");
		...
		ExtTextField<?> field1 = new ExtTextField<String>("1", new Model<String>("Jack"));
		field1.setFieldLabel(new Model<String>("First Name"));
		field1.setAllowBlank(false);
		field1.setWidth(230);
		tab1.addItem(field1);

		ExtTextField<?> field2 = new ExtTextField<String>("2", new Model<String>("Slocum"));
		field2.setFieldLabel(new Model<String>("Last Name"));
		field2.setWidth(230);
		tab1.addItem(field2);

		ExtTextField<?> field3 = new ExtTextField<String>("3", new Model<String>("Ext JS"));
		field3.setFieldLabel(new Model<String>("Company"));
		field3.setWidth(230);
		tab1.addItem(field3);
		...
		ExtTextField<?> field21 = new ExtTextField<String>("1", new Model<String>("(888) 555-1212"));
		field21.setFieldLabel(new Model<String>("Home"));
		field21.setWidth(230);
		tab2.addItem(field21);

		ExtTextField<?> field22 = new ExtTextField<String>("2", new Model<String>(""));
		field22.setFieldLabel(new Model<String>("Business"));
		field22.setWidth(230);
		tab2.addItem(field22);

		ExtTextField<?> field23 = new ExtTextField<String>("3", new Model<String>(""));
		field23.setFieldLabel(new Model<String>("Mobile"));
		field23.setWidth(230);
		tab2.addItem(field23);

		ExtTextField<?> field24 = new ExtTextField<String>("4", new Model<String>(""));
		field24.setFieldLabel(new Model<String>("Fax"));
	...
	private void addTabsForm2() {
		...
		ExtTabPanel tabPanel = new ExtTabPanel("2");
		...
		ExtHtmlEditor<String> editor = new ExtHtmlEditor<String>("1");
		// editor.setId("bio");
		editor.setFieldLabel(new Model<String>("Biography"));
		tab3.addItem(editor);
