...
public class Tabs extends ExamplesPage {
    ...
    public Tabs() {
        ...
        tab1.add(new MultiLineLabel("construct", "My content was added during construction."));
        tabs2.addTab(new Model<String>("Normal Tab"), tab1);
        tab2 = new ExtPanel();
        tab2.setAutoScroll(true);
        tab2.add(new MultiLineLabel("long2", LONG_TEXT));
        tabs2.addTab(new Model<String>("Ajax Tab 1"), tab2);

        ExtPanel tab3 = new ExtPanel();
        tab3.setAutoScroll(true);
        tab3.add(new MultiLineLabel("long3", LONG_TEXT));
        tabs2.addTab(new Model<String>("Ajax Tab 2"), tab3);

        final ExtPanel tab4 = new ExtPanel();
        tab4.setAutoScroll(true);
        tab4.add(new MultiLineLabel("event", "I am tab 4's content. I also have an event listener attached."));
        ...
        ExtPanel tab5 = new ExtPanel();
        tab5.setAutoScroll(true);
        tab5.add(new MultiLineLabel("disabled", "Can't see me cause I'm disabled"));
